                            ...
                            <div className="col-4 h-full">
                                <div className="shadow-md h-full">
                                    ...
                                    <div>
                                        ...
                                        >
                                            {({ state, set }) => {
                                                const permissionList = state.itemPermisiion
                                                const setList = set ?? ((x) => {})
                                                return (
                                                            ...
                                                            {({ state: items }) => (
                                                                ...
                                                                >
                                                                    {({ state, set }) => {
                                                                        ...
                                                                        const itemSetState = set ?? ((x) => {})
                                                                        console.log('xx', permissionList)
                                                                        return (
                                                                            <div className="p-2 shadow-sm rounded-md mb-2 hover:bg-gray-100 cursor-pointer">
                                                                                <div className="flex justify-between">
                                                                                    ...
                                                                                    <input
                                                                                        defaultChecked={true}
                                                                                        checked={itemState.itemName == items.name}
                                                                                        onChange={() => {
                                                                                            if (itemSetState) {
                                                                                                if (itemState.itemName == items.name) {
                                                                                                    itemSetState({
                                                                                                        itemName: '',
                                                                                                    })
                                                                                                } else {
