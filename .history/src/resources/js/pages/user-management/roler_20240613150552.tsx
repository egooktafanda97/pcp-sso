...
export default function Roler() {
    ...
    const hndelChangePermission = (data: any) => {
                                    ...
                                    <ElementLoop apiFetching={'/role-management/show/json'}>
                                        {({ state: items }) => (
                                            <a
                                                ...
                                                className={`flex mb-1 items-center p-2 text-base font-normal cursor-pointer rounded-lg text-white hover:bg-gray-700 ${state.nameAct == items.name ? 'bg-gray-900' : ''}`}
                                            >
                                                <FaCriticalRole />
