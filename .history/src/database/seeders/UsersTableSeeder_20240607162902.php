...
class UsersTableSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        (new UserManagementServices())->setRole(User::whereUsername('egookta')->first()->id, ['dashops', 'web']);
        ...
        (new UserManagementServices())->setPermissionRole(
            role: Role::whereName('dashops')->first()->name,
            permissionId: [$permissionId->name]
        );

        (new UserManagementServices())->setPermissionRole(
            role: Role::whereName('admin')->first()->name,
            permissionId: [$permissionId->name]
        );
    }
}
