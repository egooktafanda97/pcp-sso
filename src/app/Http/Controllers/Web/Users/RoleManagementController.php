...
class RoleManagementController extends Controller
{
    ...
    // set rules 
    #[Post("/role-permission/store")]
    public function permissionStore(Request $request)
    {
        try {
            $x = $this->userManagementServices->setPermissionRole($request->role, collect($request->permission)->pluck("name")->toArray(), affterRemove: true);
