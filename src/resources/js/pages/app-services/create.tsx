...
import { FaAppStore, FaCriticalRole, FaPlus, FaTrash } from 'react-icons/fa'
...
export default function Roler() {
    ...
    const hndelAddApp = async (data: any) => {
        await post('/app-services/store', { data: data }).then((res) => {
            console.log(res)
                    ...
                    <div className="px-3 py-4 overflow-y-auto rounded bg-gray-50 dark:bg-gray-800 h-full">
                        ...
                        <ul className="space-y-2">
                            <ElemetState elemet="li" useState={{}}>
                                {({ state }) => (
                                    <ElementLoop apiFetching={'/app-services/all'}>
                                        {({ state: items }) => (
                                            <a
                                                onClick={() => {
                ...
                <div className="w-full ml-2">
                    <div className="h-full">
                        ...
                        <div className="row h-full ">
                            <div className="col-4 h-full hidden">
