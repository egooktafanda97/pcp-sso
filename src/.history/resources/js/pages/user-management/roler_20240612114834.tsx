...
import { FaCriticalRole, FaPlus } from "react-icons/fa";
                            ...
                            >
                                {({ state }) => (
                                    <li>
                                        <a
                                            // href="#"
                                            className="text-white flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700"
                                        >
                                            <FaCriticalRole />
