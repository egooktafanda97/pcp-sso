                                        ...
                                        >
                                            {({ state, set }) => (
                                                <a
                                                    ...
                                                    className={`text-white flex items-center p-2 text-base font-normal cursor-pointer rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 ${state.active}`}
                                                >
                                                    <FaCriticalRole />
